...
interface DocumentState {
    ...
    mainPanelScrollTarget: number | null;
    setMainPanelScrollTarget: (target: number | null) => void;
    ...
    isHistoryHovering: boolean;
    setIsHistoryHovering: (val: boolean) => void;
}
...
export const useDocumentStore = create<DocumentState>((set, get) => ({
    ...
    mainPanelScrollTarget: null,
    setSidePanelScrollTarget: (sidePanelScrollTarget) => set({sidePanelScrollTarget}),
    setMainPanelScrollTarget: (mainPanelScrollTarget) => set({mainPanelScrollTarget}),
    ...
    isHistoryHovering: false,
    setIsHistoryHovering: (isHistoryHovering) => set({isHistoryHovering}),
}));